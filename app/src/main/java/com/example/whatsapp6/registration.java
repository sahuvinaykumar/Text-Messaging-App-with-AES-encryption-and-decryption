    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rg_signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressDialog.show(); // Show progress dialog when starting the process
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (imageURI != null) {
                                ...
                                imageuri = "https://firebasestorage.googleapis.com/v0/b/whatsapp-6-29f57.appspot.com/o/man.png?alt=media&token=4158328a-fa72-420d-aea5-8bf20331d236"; // Set default image URL
                                Users users = new Users(id, namee, emaill, Password, imageuri, status);
                                reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
